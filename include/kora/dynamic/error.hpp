...
//! Thrown by the parser when the input stream contains an incorrect JSON.
...
//! Base type for all errors generated by dynamic_converter.
...
//! The dynamic object is expected to be null.
...
//! The dynamic object is expected to be of type dynamic_t::bool_t.
...
//! The dynamic object is expected to be of type dynamic_t::int_t.
...
//! The dynamic object is expected to be of type dynamic_t::uint_t.
...
//! The dynamic object is expected to contain any integer number.
...
//! The dynamic object is expected to be of type dynamic_t::double_t.
...
//! The dynamic object is expected to contain any numeric value.
...
//! The dynamic object is expected to be of type dynamic_t::string_t.
...
//! The dynamic object is expected to be of type dynamic_t::array_t.
...
//! The dynamic object is expected to be of type dynamic_t::object_t.
...
//! Thrown when the converter cannot convert the value to a numeric type without data loss.
...
/*! The same as bad_numeric_cast_t, but additionally provides information about the target type.
 *
